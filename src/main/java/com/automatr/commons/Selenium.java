    ...
    public static String[] elementActions(WebDriver driver, WebElement webElement, String actionName, String actionValue, String[] miscParams) {
        ...
        try {
            ...
            switch (actionName.toLowerCase()) {
                ...
                case "hasattribute":
                    if (webElement.getAttribute(actionValue) == null) {
                        result = new String[]{"F", String.format("Expected element to have attribute &#39;%s&#39;, but found no attribute", actionValue)};
                    }
                    break;
                ...
                case "hasnoattribute":
                    if (webElement.getAttribute(actionValue) != null) {
                        result = new String[]{"F",
                                String.format("Expected element to not have attribute &#39;%s&#39;, but found attribute with value &#39;%s&#39;",
                                        actionValue,
                                        webElement.getAttribute(actionValue)
                                )};
                    }
                    break;
